...
class NotaneitorApplicacionTests {
    ...
    // Lab
    //static String PathFirefox = "C:\\Users\\uo258352\\Desktop\\FirefoxPortable\\FirefoxPortable.exe";
    static String Geckodriver = "C:\\Users\\uo258352\\Downloads\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
    ...
    //PR06B. Prueba del formulario de registro. DNI corto
    ...
    //PR06C. Prueba del formulario de registro. Nombre corto.
    ...
    public void PR06D() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Juan Carlos", "Pere", "77777", "77777");
    ...
    //PR06E. Prueba del formulario de registro. Apellido corto.
    // Propiedad: Error.signup.password.length
    @Test
    @Order(11)
    public void PR06E() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Juan Carlos", "Perez", "7", "77777");
    ...
    public void PR06F() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Juan Carlos", "Perez", "77777", "66666");
    ...
    public void PR14() {
        ...
        elements = PO_PrivateView.clickOn(driver, elements, "//li[contains(@id, 'marks-menu')]/a", 0);

        //Pinchamos en agregar Nota.
        elements = PO_PrivateView.clickOn(driver, elements, "//a[contains(@href, 'mark/add')]", 0);
        ...
        elements = PO_PrivateView.clickOn(driver, elements, "//a[contains(@class, 'page-link')]", 3);
    ...
    public void PR15() {
        ...
        elements = PO_PrivateView.clickOn(driver, elements, "//a[contains(@href, 'mark/list')]", 0);
        ...
        elements = PO_PrivateView.clickOn(driver, elements, "//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]", 0);
